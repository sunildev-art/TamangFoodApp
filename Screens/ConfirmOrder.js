...
//   justifyContent:"space-around",
  ...
  marginBottom:20,
   ...
   <TouchableOpacity onPress={()=>navigation.goBack()}>
    ...
    marginBottom:10}}/>
<TouchableOpacity style={styles.ADD_To_Order_Button_Style} onPress={()=>navigation.navigate("OrderComplete")}>
                <Text style={styles.ADD_To_Order_Button_Text_Style}>CHECKOUT (AUD $30)</Text>
            </TouchableOpacity>
    </ScrollView>
  )
}
